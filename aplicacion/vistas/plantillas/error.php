...
<link rel="stylesheet" type="text/css" href="/estilos/principalBody.css" />
...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark danger-color-dark" id="navPrincipal">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-5">
                    ...
                    <!-- Enlaces en la parte derecha -->
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo Sistema::app()->generaURL(array("usuarios","login"));?>">Iniciar Sesion</a>
                        ...
                        <li class="nav-item dropdown" id="listaDrop">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-purple" aria-labelledby="navbarDropdownMenuLink-5">
                                ...
                                <a class="dropdown-item" href="<?php echo Sistema::app()->generaURL(array("usuarios","configuracion"))?>">Configuracion</a>
		...
		<div id="todo">	
			...
			<div class="alert alert-danger">
  				<strong>ERROR</strong> Se ha producido el error:  <?php echo $mensaje;?>
            </div>
            <?php 
            echo CHTML::dibujaEtiqueta("div",array("id"=>"divBotones"),"",false);
            
            echo CHTML::link("Ir a inicio",Sistema::app()->generaURL(array("inicial","index")),array("class"=>"btn danger-color-dark"));
